...
const saveStudentProfile = async (profileData)=>{
    try {
        ...
        if (error) {
            throw new Error("Failed to save student profile: ".concat(error.message));
        }
        return data;
    } catch (error) {
...
const getStudentProfile = async (id)=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("students").select("*").eq("id", id).single();
        if (error) {
            if (error.code === "PGRST116") {
                return null; // No rows found
            }
            throw new Error("Failed to get student profile: ".concat(error.message));
        }
        return data;
    } catch (error) {
...
const getAllStudents = async ()=>{
    try {
        const { data, error } = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$supabase$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["supabase"].from("students").select("*").order("created_at", {
            ascending: false
        });
        if (error) {
            throw new Error("Failed to get students: ".concat(error.message));
        }
        return data || [];
    } catch (error) {
...
function ProfileFormPage() {
    ...
    const onSubmit = async (data)=>{
        ...
        try {
            ...
            const savedRecord = await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$students$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["saveStudentProfile"])(cleanedData);
            ...
            alert("Failed to submit profile: ".concat(error instanceof Error ? error.message : "Unknown error"));
        } finally{
...
//# sourceMappingURL=src_b8fda620._.js.map