...
export const ProfilesList: ProfileData[] = [
  {
    ...
    inspirations: ["APJ Abdul Kalam", "Warren Buffett"],
    socialLinks: {
    ...
    company: "Techjays",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/balakrishnan.pdf",
  },
  {
    id: "bavani",
    name: "Bavani K",
    ...
    summary:
      "<ul><li>Passionate mobile app developer with skills in React Native, Flutter, React.js, and UI/UX design.</li><li>Experienced in building responsive apps and crafting seamless user experiences using Figma</li></ul>",
    experience: [
      {
        company: "Accent Techno Soft",
        role: "Mobile App Developer ",
        summary:
          "<ul><li>Designed product interfaces and user flows, contributing to the overall user experience of the platform.</li><li>Created Built a mobile app to help users track daily calorie intake and monitor health goals.</li></ul>",
        website: "http://stupro.info",
      },
      {
        ...
        role: "Mobile App Developer ",
        summary:
          "<ul><li>Designed product interfaces and user flows, contributing to the overall user experience of the platform.</li><li>Create a Flutter mobile app to find and connect with local area workers. Features user-friendly UI, location-based search, and worker profile browsing.</li></ul>",
        website: "http://stupro.info",
      },
    ],
    mentorBridgeExp: {
    ...
    company: "Techjays",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/bavani.pdf",
  },
  {
    id: "devaki_ravi",
    name: "Devaki Ravi",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/devaki_ravi.jpeg",
    ...
    experience: [
      {
        ...
        role: "intern",
        summary:
          "<ul><li>I gained practical experience in full-stack development.</li><li> I worked on building responsive web pages using HTML, CSS, and JavaScript, with an emphasis on usability, structure, and performance\u2014giving me a solid foundation in how backend services connect with frontend interfaces.</li></ul>",
        website: "",
      },
    ],
    mentorBridgeExp: {
    ...
    inspirations: ["APJ Abdul Kalam", "Srinivasa Ramanujan"],
    socialLinks: {
    ...
    company: "Klyonix",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/devaki_ravi.pdf",
  },
  {
    id: "harini",
    name: "HARINI S",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/harini.jpg",
    role: "Backend Dev Engineer",
    ...
    company: "Techjays",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/harini.pdf",
  },
  {
    id: "jeyaraman",
    name: "Jeyaraman S",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/jeyaraman.jpg",
    ...
    experience: [
      ...
      },
      {
        ...
        summary:
          "<ul><li>Designed and developed a modern, responsive landing page using React, TypeScript, and Tailwind CSS.</li><li>Implemented lazy loading, animations using Framer Motion, and reusable components for scalability.</li><li>Focused on performance optimization to enhance user experience.</li></ul>",
    ...
    inspirations: ["Mark Zuckerberg", "Vetrimaaran"],
    socialLinks: {
    ...
    company: "Frigate",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/jeyaraman.pdf",
  },
  {
    id: "Jeyashree",
    name: "Jeyashree S",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Jeyashree.jpg",
    role: "Frontend Dev Engineer",
    ...
    experience: [
      {
        ...
        summary:
          "<ul><li>Using front-end development, I completed a Pet shop website and built a responsive web design.</li><li>Only using HTML, CSS, Bootstrap, and media queries to make responsive pages.</li></ul>",
      },
      {
        company: "Seval Software Solution",
        role: "Front-end Engineer",
        summary:
          "<ul><li>I have completed a web development internship during which I worked on a banking system project using HTML, CSS, and JavaScript.</li><li>Created interactive and visually appealing interfaces.</li></ul>",
      },
    ],
    mentorBridgeExp: {
      company: "Securosphere",
      ...
      summary:
        "<ul><li>I have contributed to key modules such as the Registration Page, Multi-Factor Authentication (MFA), reCAPTCHA, GitHub integration, cookie management, and RESTful API integration.</li><li>I have actively participated in pitching and promoting our product at various platforms and events.</li></ul>",
      website: "http://securosphere.in",
    },
    skillSets: ["HTML", "CSS", "Bootstrap", "React.js", "TypeScript", "UI/UX"],
    inspirations: ["Ratan Tata", "Dr. A.P.J. Abdul Kalam"],
    socialLinks: {
    ...
    company: "Klyonix",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Jeyashree.pdf",
  },
  {
    id: "kajalakshmi",
    name: "Kajalakshmi M",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/kajalakshmi.jpeg",
    role: "Frontend Dev Engineer",
    ...
    experience: [
      {
        ...
        role: "Frontend Developer",
        summary:
          "<ul><li>TastyTrails website frontend was built with a focus on clean design, responsiveness, and intuitive user experience using React.js and Bootstrap.</li><li>Developed interactive UI components and implemented smooth navigation flows to enhance user engagement across the platform.</li></ul>",
      },
    ],
    mentorBridgeExp: {
      company: "SecuroSphere",
    ...
    inspirations: ["Mahakavi Bharathi", "APJ Abdul Kalam"],
    socialLinks: {
    ...
    company: "Klyonix",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/kajalakshmi.pdf",
  },
  {
    id: "Karthekeyan_M",
    name: "Karthekeyan M",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Karthekeyan_M.jpg",
    role: "Frontend Dev Engineer",
    email: "karthekeyan.muruganantham@gmail.com",
    summary:
      "<ul><li>I am a passionate Full Stack Developer with experience in building web applications using MERN stack.</li><li>I have worked on different projects like e-commerce websites and API tools, and I enjoy creating user-friendly and responsive web apps.</li></ul>",
    experience: [
      {
        company: "Vinculo",
        role: "Full Stack Developer",
        summary:
          "<ul><li>Developed responsive and user-friendly UI using React js.Integrated Razorpay payment gateway to enable secure and seamless transactions.</li><li>Built APIs with Node.js and Express.js for fetching product and user data from MongoDB.<li></ul>",
    ...
    inspirations: ["MS Dhoni", "Nicholas Pooran"],
    socialLinks: {
    ...
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Karthekeyan_M.pdf",
  },
  {
    id: "Kiruthika_G",
    name: "Kiruthika G",
    ...
    company: "Techjays",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Kiruthika_G.pdf",
  },
  {
    id: "meena",
    name: "Meena S",
    ...
    experience: [
      {
        ...
        role: "Mobile App Developer",
        summary:
          "<ul><li>Gained hands-on experience with the Flutter framework and Sqflite database. Developed a Tour Guide App that showcases popular destinations, enabling users to share visited locations, upload images, and add descriptive insights.</li></ul>",
        website: "",
      },
      {
        company: "NSCI",
    ...
    inspirations: ["Virat Kohli", "Kunal Kushwaha"],
    socialLinks: {
    ...
    company: "Techjays",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/meena.pdf",
  },
  {
    id: "Nithya_Bala_M",
    name: "Nithya Bala M",
  ...
  },
  {
    ...
    company: "MentorBridge",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Nivethitha_M.pdf",
  },
  {
    id: "prasanna",
    name: "Prasanna",
    ...
    summary:
      "<ul><li>Innovative FullStack Developer , with a Strong foundation in Trending Technologies and ,Passion for creating the Websites to be More scalable , more Efficient and with the optimized Performance.</li></ul>",
    experience: [
      {
        company: "Sarva Vidhya Solutions",
        role: "Full stack Developer Intern",
        summary:
          "<ul><li>Built an ESS application with Express.js, MySQL, and JWT for managing employee leave records, featuring a secure admin-only dashboard for approvals.</li><li>Built an Invoice Generator using Express.js and Puppeteer to generate invoices in PDF and image formats, with secure authentication for controlled access.</li></ul>",
      },
    ],
    mentorBridgeExp: {
      company: "Securosphere",
    ...
    skillSets: ["React", "Node.js", "Spring Boot", "AWS", "Docker", "CI/CD"],
    inspirations: ["APJ Abdul Kalam"],
    socialLinks: {
    ...
    company: "CodiFi",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/prasanna.pdf",
  },
  {
    id: "Sakthi_Priya_S",
    name: "Sakthi Priya S",
    ...
    inspirations: ["William Hanna", "Virat Kohli", "Senthil Kumar T"],
    socialLinks: {
    ...
    company: "MentorBridge",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Sakthi_Priya_S.pdf",
  },
  {
    id: "Santhana_Kaleeswari_S",
    name: "Santhana Kaleeswari S",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Santhana_Kaleeswari_S.jpg",
    role: "Mobile App Developer",
  ...
  },
  {
    ...
    inspirations: ["Elon Musk", "MS Dhoni"],
    socialLinks: {
    ...
    company: "MentorBridge",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/sherin-sithara.pdf",
  },
  {
    id: "Sivasankari",
    name: "Sivasankari",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Sivasankari.jpg",
    role: "Backend dev Engineer",
    ...
    company: "CodiFi",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Sivasankari.pdf",
  },
  {
    id: "Subash",
    ...
    company: "Frigate",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Subash.pdf",
  },
  {
    id: "umar_farook",
    name: "Umar Farook J",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/umar_farook.png",
    role: "Frontend Dev Engineer",
    ...
    company: "Frigate",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/umar_farook.pdf",
  },
  {
    id: "viji",
    name: "Vijayalakshmi T",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/viji.jpg",
    role: "Frontend Dev Engineer",
    ...
    experience: [
      {
        ...
        role: "Webdeveloper",
        summary:
          "<ul><li>Developed and maintained the user interface of a web-based Rail Pass Management System using HTML5, CSS3, and JavaScript. Ensured a clean, intuitive, and functional design that improved user interaction and engagement.</li></ul>",
      },
      {
        company: "Virtuospark",
        role: "Digital Marketing",
        summary:
          "<ul><li>Designed a poster based on Webdevelopment, contributing to the overall user experience of the platform.</li><li>Created API documentation to facilitate easy understanding and implementation.</li></ul>",
      },
    ],
    mentorBridgeExp: {
      company: "Stublab",
      role: "Co-Founder | Front End Engineer",
      summary:
        "<ul><li>Designed product interfaces and user flows, contributing to the overall user experience of the platform.</li></ul>",
    ...
    company: "MentorBridge",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/viji.pdf",
  },
  {
    id: "Vijaykarthik",
    name: "Vijaykarthik S",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Vijaykarthik.png",
    role: "Frontend Dev Engineer",
    ...
    company: "MentorBridge",
    resumeLink:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Vijaykarthik.pdf",
  },
  {
    id: "Vishwadharshini",
    name: "Vishwadharshini V",
    picture:
      "https://wfkq0nguanh0273r.public.blob.vercel-storage.com/mentorbridge-pics/Vishwadharshini.jpg",
    role: "UX Designer",
